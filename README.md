...
-   3. [Run the code to reproduce Simulations and figures](#RunthecodetoreproduceSimulationsandfigures)
...
## 3. <a name='RunthecodetoreproduceSimulationsandfigures'></a>Run the code to reproduce Simulations and figures
